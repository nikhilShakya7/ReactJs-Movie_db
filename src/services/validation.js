...
const schema= yup.object().shape({
    ...
    year:yup.number().typeError("Must be a number").min(1878,"Thats earlier than the first motion picture").max(new Date().getFullYear(),"You cannot be in the future").required("Date is required"),
